$(document).ready(function () {
  ...
  var table = $("#listar-admin").DataTable();

  $("#listar-admin tbody").on("click", "#visualizar", function () {
  ...
  $("#listar-admin tbody").on("click", "#editar", function () {
    var meu_id = $(this).data("id"); //pega o id que o botão passou
    $.ajax({
  ...
  $("#listar-admin tbody").on("click", "#deletar", function () {
    var meu_id = $(this).data("id"); //pega o id que o botão passou
    $.ajax({
